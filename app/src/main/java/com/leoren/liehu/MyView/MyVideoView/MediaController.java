package com.leoren.liehu.MyView.MyVideoView;
...
//    private boolean mFullscreenEnabled = false;
    ...
    private void initControllerView(View v) {
        mTitleLayout = v.findViewById(R.id.video_title_part);
        ...
        mBackButton = v.findViewById(R.id.video_back_btn);
        ...
        View bar = v.findViewById(R.id.video_seekBar);
        ...
        mEndTime =  v.findViewById(R.id.video_duration);
        mCurrentTime =  v.findViewById(R.id.has_played);
        mTitle =  v.findViewById(R.id.video_title_text);
    ...
    public void reset() {
        ...
        mTurnButton.setImageResource(R.drawable.video_player_player_btn);
    ...
    private void updatePausePlay() {
        if (mPlayer != null && mPlayer.isPlaying()) {
            mTurnButton.setImageResource(R.drawable.video_stop_btn);
//            mCenterPlayButton.setVisibility(GONE);
        } else {
            mTurnButton.setImageResource(R.drawable.video_player_player_btn);
//            mCenterPlayButton.setVisibility(VISIBLE);
    ...
    void updateScaleButton() {
        if (mIsFullScreen) {
            mScaleButton.setImageResource(R.drawable.video_star_zoom_in);
        } else {
            mScaleButton.setImageResource(R.drawable.video_player_scale_btn);
        }
    }
